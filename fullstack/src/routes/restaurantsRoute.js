...
function Router(menu){
  restaurantsRouter.route('/')
  .get(function(req,res){
    res.render('restaurant',{title:'Restaurant Page',menu,restaurants:restaurants})
})
...
restaurantsRouter.route('/details/:id')
  .get(function(req,res){
    ...
    for(item of restaurants)
    {
      ...
      {
        console.log(item)
        res.render('restaurantDetails',{menu:menu,details:item})
      }
    }
   // res.render('restaurantDetails',{menu:menu,details:resarr})
});
return restaurantsRouter
}
